...
# Load audio file
sr = 44100
with AudioFile('C:\\Users\\jrjga\\Documents\\MuseScore4\\Scores\\HelloWorld\\trumpetTest1(80)[MSBasic]{Pause}(C5).wav').resampled_to(sr) as f:
...
with AudioFile(
    'C:\\Users\\jrjga\\Documents\\HelloWorld\\trumpetTest1Trimmed.wav', 
    'w', 
    sr, 
